...
app.controller('personsListController', function ($scope, $rootScope, personService) {
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
            ...
            { field: 'materia', displayName: 'Matéria' },
            { field: 'data', displayName: 'Data' },
            { field: 'qtdeHoras', displayName: 'Qtde Horas' },
            { field: 'Status', displayName: 'Status' },
            { field: 'Excluir', width: 30, cellTemplate: '<span class="glyphicon glyphicon-remove remove" ng-click="deleteRow(row)"></span>' }
        ],
